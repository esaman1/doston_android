package com.dinosoftlabs.tictic.UserDiscover_Classes;
...
//        holder.followers_videos.setText(prettyCount(user_list.get(position).getFollowersCount())+" followers \u00b7 "+prettyCount(user_list.get(position).getVideoCount())+" videos");
        holder.followers_count_tx.setText("Followers "+ Functions.prettyCount(user_list.get(position).getFollowersCount()));
        holder.videos_count_tx.setText("Videos "+Functions.prettyCount(user_list.get(position).getVideoCount()));
