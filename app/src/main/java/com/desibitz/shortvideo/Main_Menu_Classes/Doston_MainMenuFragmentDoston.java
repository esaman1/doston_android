package com.desibitz.shortvideo.Main_Menu_Classes;
...
import com.desibitz.shortvideo.Login_Classes.Doston_Login_User;
import com.desibitz.shortvideo.UserDiscover_Classes.Doston_Discover_F;
import com.desibitz.shortvideo.Home_Fragement_Classes.Doston_Home_F;
import com.desibitz.shortvideo.Inbox_Message_Classes.Doston_Inbox_F;
import com.desibitz.shortvideo.Main_Menu_Classes.RelateToFragment_OnBack.Doston_OnBackPressListener;
import com.desibitz.shortvideo.Main_Menu_Classes.RelateToFragment_OnBack.Doston_RootFragment;
import com.desibitz.shortvideo.Profile_Classes.Doston_Profile_Tab_F;
...
public class Doston_MainMenuFragmentDoston extends Doston_RootFragment implements View.OnClickListener {
    ...
    protected Doston_Custom_ViewPager pager;

    private ViewPagerAdapter adapter;
    Context context;


    public Doston_MainMenuFragmentDoston() {
    ...
    public boolean onBackPressed() {
        ...
        Doston_OnBackPressListener currentFragment = (Doston_OnBackPressListener) adapter.getRegisteredFragment(pager.getCurrentItem());
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_home));
        title1.setText("\u2022");
        ...
        imageView2.setImageDrawable(getResources().getDrawable(R.drawable.ic_search));
        imageView2.setColorFilter(ContextCompat.getColor(context, R.color.colorwhite_50), android.graphics.PorterDuff.Mode.SRC_IN);
        title2.setText("\u2022");
        title2.setTextColor(context.getResources().getColor(R.color.transperent));
...
//        tabLayout.getTabAt(3).setCustomView(view4);
        ...
        imageView5.setImageDrawable(getResources().getDrawable(R.drawable.ic_user_profile));
        imageView5.setColorFilter(ContextCompat.getColor(context, R.color.colorwhite_50), android.graphics.PorterDuff.Mode.SRC_IN);
        title5.setText("\u2022");
        title5.setTextColor(context.getResources().getColor(R.color.transperent));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener(){
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    case 0:
                        OnHome_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_home));
                        title.setTextColor(context.getResources().getColor(R.color.white));
                        break;

                    case 1:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_search));
                    ...
                    case 3:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_message));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.white), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.white));
                        break;
                    case 4:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_user_profile));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.white), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.white));
                        break;
                }
...
//        tabStrip.getChildAt(4).setClickable(false);
        ...
        if(Doston_MainMenuActivity.intent!=null){

            if(Doston_MainMenuActivity.intent.hasExtra("action_type")) {


                if (Variables.sharedPreferences.getBoolean(Variables.islogin, false)) {
                    String action_type= Doston_MainMenuActivity.intent.getExtras().getString("action_type");
                    ...
                    if(action_type.equals("message")){
                        ...
                        String id= Doston_MainMenuActivity.intent.getExtras().getString("senderid");
                        String name= Doston_MainMenuActivity.intent.getExtras().getString("title");
                        String icon= Doston_MainMenuActivity.intent.getExtras().getString("icon");
    ...
    class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    result = new Doston_Home_F();
                    break;

                case 1:
                    result = new Doston_Discover_F();
                    break;

                case 2:
                    result=new Doston_BlankFragmentDoston();
                    break;

                case 3:
                    result = new Doston_Inbox_F();
                    break;

                case 4:
                    result = new Doston_Profile_Tab_F();
                    break;
    ...
    public void OnHome_Click (){
        ...
        tex1.setTextColor(context.getResources().getColor(R.color.transperent));
        tab1.setCustomView(view1);

        TabLayout.Tab tab2=tabLayout.getTabAt(2);
        View view2=tab2.getCustomView();
        ImageView image= view2.findViewById(R.id.image);
        image.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_add));
        ...
        tex3.setTextColor(context.getResources().getColor(R.color.transperent));
