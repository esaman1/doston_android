...
import com.desibitz.shortvideo.SegmentProgress_Classes.Doston_ProgressBarListener;
import com.desibitz.shortvideo.SegmentProgress_Classes.Doston_SegmentedProgressBar;
import com.desibitz.shortvideo.SimpleClasses.Doston_Functions;
import com.desibitz.shortvideo.SimpleClasses.Variables;
import com.desibitz.shortvideo.SoundLists.Doston_SoundList_Main_A;
import com.desibitz.shortvideo.Video_Recording.GalleryVideos.GalleryVideos_A;
...
public class Video_Recoder_A extends AppCompatActivity implements View.OnClickListener {
    ...
    Doston_SegmentedProgressBar video_progress;
    ...
    public void initlize_Video_progress(){
        ...
        video_progress.SetListener(new Doston_ProgressBarListener() {
            @Override
    ...
    public void Start_or_Stop_Recording(){
        ...
        if (!is_recording && sec_passed<(Variables.recording_duration/1000)-1) {
            ...
            Doston_Functions.Show_Alert(this,"Alert","Video only can be a "+(int)Variables.recording_duration/1000+" S");
        }
...
//                Toast.makeText(this, "SOUND_CLICK", Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(this, Doston_SoundList_Main_A.class);
