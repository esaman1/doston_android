package com.desibitz.shortvideo.Video_Recording;
...
import com.desibitz.shortvideo.Video_Filter_Classes.Doston_FilterType;
import com.desibitz.shortvideo.Video_Filter_Classes.Doston_Filter_Adapter;
...
public class Preview_Video_A extends AppCompatActivity  implements Player.EventListener {
    ...
    final List<Doston_FilterType> dostonFilterTypes = Doston_FilterType.createFilterList();
    Doston_Filter_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Doston_Filter_Adapter(this, dostonFilterTypes, new Doston_Filter_Adapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int postion, Doston_FilterType item) {
                select_postion=postion;
                gpuPlayerView.setGlFilter(Doston_FilterType.createGlFilter(dostonFilterTypes.get(postion), getApplicationContext()));
...
//        gpuPlayerView.setPlayerScaleType(PlayerScaleType.RESIZE_NONE);
    ...
    public void Save_Video(String srcMp4Path, final String destMp4Path){
        ...
        new GPUMp4Composer(srcMp4Path, destMp4Path)
                ...
                .filter(new GlFilterGroup(Doston_FilterType.createGlFilter(dostonFilterTypes.get(select_postion), getApplicationContext())))
