package com.desibitz.shortvideo.Video_Recording.GalleryVideos;
...
import com.desibitz.shortvideo.Video_Recording.GallerySelectedVideo.GallerySelectedVideo_A;
    ...
    public  void startTrim(final File src, final File dst, final int startMs, final int endMs) throws IOException {
        ...
        new AsyncTask<String,Void,String>() {
                ...
                try {
                    ...
                    for (Track track : tracks) {
                        if (track.getSyncSamples() != null && track.getSyncSamples().length > 0) {
                            ...
                            startTime = Doston_Functions.correctTimeToSyncSample(track, startTime, false);
                            endTime = Doston_Functions.correctTimeToSyncSample(track, endTime, true);
                            timeCorrected = true;
                        }
                    }
                    for (Track track : tracks) {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                Doston_Functions.Show_indeterminent_loader(GalleryVideos_A.this,true,true);
            }
            ...
            protected void onPostExecute(String result) {
                if(result.equals("error")){
                    ...
                    Doston_Functions.cancel_indeterminent_loader();
