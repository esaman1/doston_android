package com.desibitz.shortvideo.Video_Filter_Classes;
...
import com.desibitz.shortvideo.Video_Recording.Preview_Video_A;
...
public class Doston_Filter_Adapter extends RecyclerView.Adapter<Doston_Filter_Adapter.CustomViewHolder> {
    public Context context;

    List<Doston_FilterType> datalist;

    Bitmap image;

    public interface OnItemClickListener {
        void onItemClick(View view, int postion, Doston_FilterType item);
    }

    public Doston_Filter_Adapter.OnItemClickListener listener;


    public Doston_Filter_Adapter(Context context, List<Doston_FilterType> arrayList, Doston_Filter_Adapter.OnItemClickListener listener) {
    ...
    @Override
    public Doston_Filter_Adapter.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        ...
        Doston_Filter_Adapter.CustomViewHolder viewHolder = new Doston_Filter_Adapter.CustomViewHolder(view);
        return viewHolder;
    }
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int pos, final Doston_FilterType item, final Doston_Filter_Adapter.OnItemClickListener listener) {
    ...
    @Override
    public void onBindViewHolder(final Doston_Filter_Adapter.CustomViewHolder holder, final int i) {
        holder.setIsRecyclable(false);
        String s = datalist.get(i).name();
        holder.fiter_txt.setText(s);
        if (Preview_Video_A.select_postion == i) {
            holder.ivPhoto.setBackgroundColor(context.getResources().getColor(R.color.white));
        }
