...
public enum Doston_FilterType {
    ...
    public static List<Doston_FilterType> createFilterList() {
        return Arrays.asList(Doston_FilterType.values());
    }

    public static GlFilter createGlFilter(Doston_FilterType dostonFilterType, Context context) {
        switch (dostonFilterType) {
            case DEFAULT:
                return new GlFilter();
            case BILATERAL_BLUR:
