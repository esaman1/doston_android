package com.desibitz.shortvideo.KeyBoard_Classes;
 ...
 */
public class Doston_KeyboardHeightProvider extends PopupWindow {

    /** The tag for logging purposes */
    private final static String TAG = "sample_KeyboardHeightProvider";

    /** The keyboard height observer */
    private Doston_KeyboardHeightObserver observer;
     ...
     */
    public Doston_KeyboardHeightProvider(Activity activity) {
        super(activity);
     ...
     */
    public void setKeyboardHeightObserver(Doston_KeyboardHeightObserver observer) {
