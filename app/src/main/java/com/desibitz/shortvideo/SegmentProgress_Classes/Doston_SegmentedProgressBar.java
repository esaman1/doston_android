package com.desibitz.shortvideo.SegmentProgress_Classes;
...
public class Doston_SegmentedProgressBar extends View {
    ...
    private Doston_CountDownTimerWithPause dostonCountDownTimerWithPause;

    private float cornerRadius;

    Doston_ProgressBarListener listener;

    public Doston_SegmentedProgressBar(Context context) {
        super(context);
        init();
    }

    public Doston_SegmentedProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Doston_SegmentedProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void SetListener(Doston_ProgressBarListener listeter){
    ...
    public void resume() {
        ...
        dostonCountDownTimerWithPause.resume();
    }

    public void reset() {
        dostonCountDownTimerWithPause.cancel();
    ...
    public void enableAutoProgressView(long timeInMillis) {
        ...
        dostonCountDownTimerWithPause = new Doston_CountDownTimerWithPause(maxTimeInMillis, FPS_IN_MILLI, false) {
            @Override
            public void onTick(long millisUntilFinished) {
                long timePassed = Doston_SegmentedProgressBar.this.maxTimeInMillis - millisUntilFinished;
                updateProgress(timePassed);
            }

            @Override
            public void onFinish() {
                updateProgress(Doston_SegmentedProgressBar.this.maxTimeInMillis);
            }
        }.create();
    }
