 ...
 */
public abstract class Doston_CountDownTimerWithPause {
     ...
     */
    public Doston_CountDownTimerWithPause(long millisOnTimer, long countDownInterval, boolean runAtStart) {
     ...
     */
    public synchronized final Doston_CountDownTimerWithPause create() {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (Doston_CountDownTimerWithPause.this) {
