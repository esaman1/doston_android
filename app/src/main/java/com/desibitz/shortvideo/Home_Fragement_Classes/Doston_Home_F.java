package com.desibitz.shortvideo.Home_Fragement_Classes;
...
public class Doston_Home_F extends Doston_RootFragment implements Player.EventListener, Fragment_Data_Send {
...
//        });
    ...
    Doston_Home_Adapter adapter;
    public void Set_Adapter(){

         adapter=new Doston_Home_Adapter(context, data_list, new Doston_Home_Adapter.OnItemClickListener() {
            @Override
...
//                        }
                    ...
                    case R.id.sound_image_layout:
                        if(Variables.sharedPreferences.getBoolean(Variables.islogin,false)) {
                            if(check_permissions()) {
                                Intent intent = new Intent(getActivity(), Doston_VideoSound_A.class);
    ...
    private void Call_Api_For_get_Allvideos() {
        ...
        Log.d(Variables.tag, Doston_MainMenuActivity.token);
...
//                    }
        ...
        if(Variables.sharedPreferences.getBoolean(Variables.islogin,false))
        Doston_Functions.Call_Api_For_update_view(getActivity(),item.video_id);
...
//    }
   ...
   // when we swipe for another video this will relaese the privious player
    ...
    public void Like_Video(final int position, final Doston_Home_Get_Set dostonHome_get_set){
        ...
        Doston_Functions.Call_Api_For_like_video(getActivity(), dostonHome_get_set.video_id, action,new Doston_API_CallBack() {
    ...
    private void OpenComment(Doston_Home_Get_Set item) {

        int comment_counnt=Integer.parseInt(item.video_comment_count);

        Fragment_Data_Send fragment_data_send=this;

        Doston_Comment_F dostonComment_f = new Doston_Comment_F(comment_counnt,fragment_data_send);
        ...
        transaction.replace(R.id.MainMenuFragment, dostonComment_f).commit();
    ...
    private void OpenHashtag(String tag) {
            ...
            transaction.addToBackStack(null);
            transaction.replace(R.id.MainMenuFragment, dostonTaged_videos_f).commit();
