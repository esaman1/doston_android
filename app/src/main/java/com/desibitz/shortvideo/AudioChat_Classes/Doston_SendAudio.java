package com.desibitz.shortvideo.AudioChat_Classes;
...
public class Doston_SendAudio {
    ...
    public Doston_SendAudio(Context context, EditText message_field,
    ...
    public void UploadAudio(){
        ...
        Doston_Chat_Activity.uploading_Audio_id=key;
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Doston_Chat_Activity.uploading_Audio_id="none";
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                ...
                                Adduser_to_inbox.updateChildren(both_user_map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Doston_Chat_Activity.SendPushNotification((Activity) context,Variables.user_name,"Send an Audio...",
                                                Variables.user_pic,
                                                Doston_Chat_Activity.token,Receiverid,senderid);
