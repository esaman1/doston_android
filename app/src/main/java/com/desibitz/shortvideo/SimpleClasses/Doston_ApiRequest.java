...
public class Doston_ApiRequest {
    ...
    public static void Call_Api (final Context context, String url, JSONObject jsonObject,
        ...
        if(jsonObject!=null)
        Log.d("LogTestJSON_jsonObject",jsonObject.toString());
         ...
         JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Log.d("LogTestJSON",response.toString());
                        }
...
//                Toast.makeText(context, "Api run timeout", Toast.LENGTH_SHORT).show();
        ...
        Log.d("LogTestJSON_req",""+jsonObjReq.getUrl());
