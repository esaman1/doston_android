package com.desibitz.shortvideo.SimpleClasses;
...
public class Variables {
    ...
    public static String app_folder=root+"/DesiBitz/";
    ...
    public static String tag="doston_";
    ...
    public static String gif_api_key1="rdoiHePjqPciFmzXZxWrE7rsURVAixgR";
...
//    public static String domain="http://13882f5bf04f.ngrok.io/TicTic/DostarAPI/index.php?p=";
//    public static String base_url="http://13882f5bf04f.ngrok.io/TicTic/DostarAPI/";
    ...
    public static String deleteUserAccount =domain+"deleteUserAccount";
