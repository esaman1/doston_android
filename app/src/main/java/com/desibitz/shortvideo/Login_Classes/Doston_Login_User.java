package com.desibitz.shortvideo.Login_Classes;
...
public class Doston_Login_User extends Activity {
...
//                Loginwith_FB();
        ...
        ss.setSpan(clickableSpan, 99, 113, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ss.setSpan(clickableSpan_terms, 116, ss.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private void Open_terms_policy() {
        Intent privacyPolicy = new Intent (this, TermsOfUse.class);
...
//                .logInWithReadPermissions(Doston_Login_User.this,
...
//                // App code
//                Toast.makeText(Doston_Login_User.this, "Login Cancel", Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
...
//                        } else {
//
//                            Toast.makeText(Doston_Login_User.this, "Authentication failed.",
...
//            mCallbackManager.onActivityResult(requestCode, resultCode, data);
    ...
    public void Sign_in_with_gmail(){
        ...
        GoogleSignInAccount account = GoogleSignIn.getLastSignedInAccount(Doston_Login_User.this);
        if (account != null) {
    ...
    private void Call_Api_For_Signup(String id,
        ...
        iosDialog.show();
        Doston_ApiRequest.Call_Api(this, Variables.SignUp, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                iosDialog.cancel();
                Parse_signup_data(resp);
                Log.d("ApiCallBack",""+resp);
