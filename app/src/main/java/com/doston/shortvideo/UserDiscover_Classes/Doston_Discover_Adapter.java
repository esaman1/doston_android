...
public class Doston_Discover_Adapter extends RecyclerView.Adapter<Doston_Discover_Adapter.CustomViewHolder > implements Filterable {
    public Context context;

    ArrayList<Doston_Discover_Get_Set> datalist;
    ArrayList<Doston_Discover_Get_Set> datalist_filter;

    public interface OnItemClickListener {
        void onItemClick(ArrayList<Doston_Home_Get_Set> video_list, int postion);
    }

    public Doston_Discover_Adapter.OnItemClickListener listener;

    public Doston_Discover_Adapter(Context context, ArrayList<Doston_Discover_Get_Set> arrayList, Doston_Discover_Adapter.OnItemClickListener listener) {
    ...
    @Override
    public Doston_Discover_Adapter.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        ...
        Doston_Discover_Adapter.CustomViewHolder viewHolder = new Doston_Discover_Adapter.CustomViewHolder(view);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(final Doston_Discover_Adapter.CustomViewHolder holder, final int i) {

        Doston_Discover_Get_Set item = datalist_filter.get(i);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Doston_Discover_Get_Set> filteredList = new ArrayList<>();
                    for (Doston_Discover_Get_Set row : datalist) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                datalist_filter = (ArrayList<Doston_Discover_Get_Set>) filterResults.values;
    ...
    class Horizontal_Adapter extends RecyclerView.Adapter<Horizontal_Adapter.CustomViewHolder> {
        ...
        ArrayList<Doston_Home_Get_Set> datalist;


        public Horizontal_Adapter(Context context, ArrayList<Doston_Home_Get_Set> arrayList) {
            this.context = context;
            datalist = arrayList;
        }
        ...
        class CustomViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final int pos, final ArrayList<Doston_Home_Get_Set> datalist) {
        ...
        public void onBindViewHolder(final Horizontal_Adapter.CustomViewHolder holder, final int i) {
            ...
            try {
                Doston_Home_Get_Set item = datalist.get(i);
