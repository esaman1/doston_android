package com.doston.shortvideo.Taged;
 ...
 */
public class Doston_Taged_Videos_F extends Doston_RootFragment {
    ...
    private void Call_Api_For_get_Allvideos() {
        ...
        Doston_ApiRequest.Call_Api(context, Variables.SearchByHashTag, parameters, new Callback() {
            @Override
