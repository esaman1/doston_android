...
public class Doston_Watch_Videos_Adapter extends RecyclerView.Adapter<Doston_Watch_Videos_Adapter.CustomViewHolder > {

    public Context context;
    private Doston_Watch_Videos_Adapter.OnItemClickListener listener;
    ...
    public Doston_Watch_Videos_Adapter(Context context, ArrayList<Doston_Home_Get_Set> dataList, Doston_Watch_Videos_Adapter.OnItemClickListener listener) {
    ...
    @Override
    public Doston_Watch_Videos_Adapter.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_watch_layout,null);
        view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.MATCH_PARENT));
        Doston_Watch_Videos_Adapter.CustomViewHolder viewHolder = new Doston_Watch_Videos_Adapter.CustomViewHolder(view);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(final Doston_Watch_Videos_Adapter.CustomViewHolder holder, final int i) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int postion, final Doston_Home_Get_Set item, final Doston_Watch_Videos_Adapter.OnItemClickListener listener) {
