package com.doston.shortvideo.Following_Classes;
 ...
 */
public class Doston_Following_F extends Fragment {
    ...
    Doston_Following_Adapter adapter;
    ...
    public Doston_Following_F(Fragment_Callback fragment_callback) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter=new Doston_Following_Adapter(context, following_or_fan,datalist, new Doston_Following_Adapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int postion, Doston_Following_Get_Set item) {
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                for (int i=0;i<msgArray.length();i++) {
                    ...
                    Doston_Following_Get_Set item=new Doston_Following_Get_Set();
    ...
    private void Call_Api_For_get_Allfan() {
        ...
        Doston_ApiRequest.Call_Api(context, Variables.get_followers, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
    ...
    private void OpenProfile(final Doston_Following_Get_Set item) {
