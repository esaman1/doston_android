 ...
 */
public class Doston_Favourite_Sound_F extends Doston_RootFragment implements Player.EventListener {
    ...
    Doston_Favourite_Sound_Adapter adapter;
    ...
    public Doston_Favourite_Sound_F() {
    ...
    public void Set_adapter(){
        ...
        adapter=new Doston_Favourite_Sound_Adapter(context, datalist, new Doston_Favourite_Sound_Adapter.OnItemClickListener() {
            @Override
    ...
    private void Call_Api_For_get_allsound() {
        ...
        Doston_ApiRequest.Call_Api(context, Variables.my_FavSound, parameters, new Callback() {
            @Override
    ...
    private void Call_Api_For_Fav_sound(String video_id) {
        ...
        Doston_ApiRequest.Call_Api(context, Variables.fav_sound, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                iosDialog.cancel();
            }
